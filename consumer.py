...
def predictions(batch, batch_num):
    global spark
    ...
    print("Metricas del modelo GBT Classifier para el batch {0} de tamano {1}".format(batch_num, len(batch)))
